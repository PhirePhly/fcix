...
sed 's/router id 206.80.238.253/router id 206.80.238.254/' RS1.bird.conf >RS2.bird.conf
sed 's/router id 206.80.238.253/router id 206.80.238.254/' RS1.bird6.conf >RS2.bird6.conf
